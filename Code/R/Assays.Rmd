...
ggsave(file_path, device = "png", width=10)
}
...
ggplot(data=df_lines, mapping=aes(x=x_lines, y=y_lines, color=group)) + 
  ...
  labs(x="Regression Slopes 95% Confidence Intervals", y="", color="Condition_Exposure Time",
       title="Slope Confidence Intervals for SVGp12 dosed with Ox66 (LDH)") +
  theme_bw() +
  theme(axis.text.y = element_blank(), axis.ticks.y = element_blank(),
        panel.grid.major = element_blank(), panel.grid.minor = element_blank()) 

ggsave("../../Graphs/SVG/SVG_DEP_Ox66_LDH_CE.png", device = "png", height=3)
